...
3. **Spawn 2 subagents in parallel** — one message, two `Task` calls,
   ...
   - **planner** — "Read `.opencode/agents/planner.md` and follow it exactly. Feature: <verbatim>."
   - **skeptic** — "Read `.opencode/agents/skeptic.md` and follow it exactly. Feature: <verbatim>."
